...
- **Blockfrost API key** — get one at [blockfrost.io](https://blockfrost.io) (Preprod project)
- **Pinata JWT** — get one at [pinata.cloud](https://pinata.cloud) (for IPFS pinning)
...
Only needed if running the indexer locally:
